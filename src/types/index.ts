...
export type ConnectorMxInitializeInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>
  /** translation missing: en.connector.mx.initialize.color_scheme.graphql_description */
  colorScheme?: InputMaybe<Scalars['String']>
  /** translation missing: en.connector.mx.initialize.include_transactions.graphql_description */
  includeTransactions?: InputMaybe<Scalars['Boolean']>
  /** translation missing: en.connector.mx.initialize.is_mobile_webview.graphql_description */
  isMobileWebview?: InputMaybe<Scalars['Boolean']>
  /** translation missing: en.connector.mx.initialize.mode.graphql_description */
  mode?: InputMaybe<Scalars['String']>
  /** translation missing: en.connector.mx.initialize.wait_for_full_aggregation.graphql_description */
...
export type ConnectorPlaidInitializeInput = {
  /** translation missing: en.connector.plaid.initialize.account_filters.graphql_description */
  ...
  /** translation missing: en.connector.plaid.initialize.auth.graphql_description */
  ...
  /** translation missing: en.connector.plaid.initialize.eu_config.graphql_description */
  ...
  /** translation missing: en.connector.plaid.initialize.update.graphql_description */
...
export type MxConnector = {
  ...
  /** translation missing: en.mx.connector.connect_widget_url.graphql_description */
  connectWidgetUrl?: Maybe<Scalars['String']>
  /** translation missing: en.mx.connector.guid.graphql_description */
  guid?: Maybe<Scalars['String']>
}
...
export type PlaidConnector = {
  ...
  /** translation missing: en.plaid.connector.expiration.graphql_description */
  expiration: Scalars['DateTime']
  /** translation missing: en.plaid.connector.link_token.graphql_description */
  linkToken: Scalars['String']
  /** translation missing: en.plaid.connector.request_id.graphql_description */
  requestId: Scalars['String']
}

/** translation missing: en.types.plaid.credit_filter_type.graphql_description */
export type PlaidCreditFilter = {
  /** translation missing: en.types.plaid.credit_filter_type.account_subtypes.graphql_description */
  accountSubtypes?: InputMaybe<Array<Scalars['String']>>
}

/** translation missing: en.types.plaid.depository_filter_type.graphql_description */
export type PlaidDepositoryFilter = {
  /** translation missing: en.types.plaid.depository_filter_type.account_subtypes.graphql_description */
  accountSubtypes?: InputMaybe<Array<Scalars['String']>>
}
...
/** translation missing: en.types.plaid.investment_filter_type.graphql_description */
export type PlaidInvestmentFilter = {
  /** translation missing: en.types.plaid.investment_filter_type.account_subtypes.graphql_description */
  accountSubtypes?: InputMaybe<Array<Scalars['String']>>
}

/** translation missing: en.types.plaid.link_token_account_filters_type.graphql_description */
export type PlaidLinkTokenAccountFilters = {
  /** translation missing: en.types.plaid.link_token_account_filters_type.credit.graphql_description */
  credit?: InputMaybe<PlaidCreditFilter>
  /** translation missing: en.types.plaid.link_token_account_filters_type.depository.graphql_description */
  depository?: InputMaybe<PlaidDepositoryFilter>
  /** translation missing: en.types.plaid.link_token_account_filters_type.investment.graphql_description */
  investment?: InputMaybe<PlaidInvestmentFilter>
  /** translation missing: en.types.plaid.link_token_account_filters_type.loan.graphql_description */
  loan?: InputMaybe<PlaidLoanFilter>
}

/** translation missing: en.types.plaid.link_token_create_request_auth_type.graphql_description */
export type PlaidLinkTokenCreateRequestAuth = {
  /** translation missing: en.types.plaid.link_token_create_request_auth_type.flow_type.graphql_description */
  flowType?: InputMaybe<Scalars['String']>
}

/** translation missing: en.types.plaid.link_token_create_request_update_type.graphql_description */
export type PlaidLinkTokenCreateRequestUpdate = {
  /** translation missing: en.types.plaid.link_token_create_request_update_type.account_selection_enabled.graphql_description */
  accountSelectionEnabled?: InputMaybe<Scalars['Boolean']>
}

/** translation missing: en.types.plaid.link_token_eu_config_type.graphql_description */
export type PlaidLinkTokenEuConfig = {
  /** translation missing: en.types.plaid.link_token_eu_config_type.headless.graphql_description */
  headless?: InputMaybe<Scalars['Boolean']>
}

/** translation missing: en.types.plaid.loan_filter_type.graphql_description */
export type PlaidLoanFilter = {
  /** translation missing: en.types.plaid.loan_filter_type.account_subtypes.graphql_description */
  accountSubtypes?: InputMaybe<Array<Scalars['String']>>
}
...
export type ConnectionSyncStatusQueryVariables = Exact<{
  id: Scalars['ID']
}>

export type ConnectionSyncStatusQuery = {
  __typename?: 'Query'
  connection?: { __typename?: 'ConnectionType'; id: string } | null | undefined
}
...
export type ConnectorPlaidInitializeMutation = {
  ...
  connectorPlaidInitialize?:
    | {
        __typename?: 'ConnectorPlaidInitializePayload'
        record?:
          | { __typename?: 'PlaidConnector'; linkToken: string; expiration: any }
          | null
          | undefined
        errors?:
          | Array<{
...
export type ConnectionDeleteMutation = {
  ...
  connectionDelete?:
    | {
        __typename?: 'ConnectionDeletePayload'
        success: boolean
        record?: { __typename?: 'ConnectionType'; id: string } | null | undefined
      }
    | null
    | undefined
}

export type ConectionUpdatedSubscriptionVariables = Exact<{
  id: Scalars['ID']
}>

export type ConectionUpdatedSubscription = {
  __typename?: 'Subscription'
  connectionUpdated: {
    __typename?: 'ConnectionUpdatedPayload'
    record?:
...
export type RoundUpsBankConnectionsSummaryCardHeaderQuery = {
  __typename?: 'Query'
  connections?: Array<{ __typename?: 'ConnectionType'; id: string }> | null | undefined
}
...
export type RoundUpsConnectionsQueryVariables = Exact<{
  roundUpId: Scalars['ID']
  id: Scalars['ID']
}>

export type RoundUpsConnectionsQuery = {
  __typename?: 'Query'
  roundUp?:
    | {
        __typename?: 'RoundUp'
...
export type RoundUpsPauseMutation = {
  ...
  roundUpPause?:
    | {
        __typename?: 'RoundUpPausePayload'
        record?: { __typename?: 'RoundUp'; id: string; state: LedgerState } | null | undefined
      }
    | null
    | undefined
}
...
export const ConnectionSyncStatusDocument = gql`
  query ConnectionSyncStatus($id: ID!) {
    connection(id: $id) {
      id
    }
  }
...
/**
 * __useConnectionSyncStatusQuery__
 *
 * To run a query within a React component, call `useConnectionSyncStatusQuery` and pass it any options that fit your needs.
 * When your component renders, `useConnectionSyncStatusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useConnectionSyncStatusQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
...
export function useConnectionSyncStatusQuery(
  baseOptions: Apollo.QueryHookOptions<
    ConnectionSyncStatusQuery,
    ConnectionSyncStatusQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ConnectionSyncStatusQuery, ConnectionSyncStatusQueryVariables>(
    ConnectionSyncStatusDocument,
    options
  )
}
export function useConnectionSyncStatusLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ConnectionSyncStatusQuery, ConnectionSyncStatusQueryVariables>(
    ConnectionSyncStatusDocument,
    options
  )
}
export type ConnectionSyncStatusQueryHookResult = ReturnType<typeof useConnectionSyncStatusQuery>
export type ConnectionSyncStatusLazyQueryHookResult = ReturnType<
  typeof useConnectionSyncStatusLazyQuery
>
export type ConnectionSyncStatusQueryResult = Apollo.QueryResult<
  ConnectionSyncStatusQuery,
  ConnectionSyncStatusQueryVariables
>
...
export type ConnectionDeleteMutationOptions = Apollo.BaseMutationOptions<
  ...
  ConnectionDeleteMutationVariables
>
export const ConectionUpdatedDocument = gql`
  subscription ConectionUpdated($id: ID!) {
    connectionUpdated(id: $id) {
      record {
        ...ConnectionAttributes
      }
    }
...
/**
 * __useConectionUpdatedSubscription__
 *
 * To run a query within a React component, call `useConectionUpdatedSubscription` and pass it any options that fit your needs.
 * When your component renders, `useConectionUpdatedSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useConectionUpdatedSubscription({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useConectionUpdatedSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<
    ConectionUpdatedSubscription,
    ConectionUpdatedSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<
    ConectionUpdatedSubscription,
    ConectionUpdatedSubscriptionVariables
  >(ConectionUpdatedDocument, options)
}
export type ConectionUpdatedSubscriptionHookResult = ReturnType<
  typeof useConectionUpdatedSubscription
>
export type ConectionUpdatedSubscriptionResult =
  Apollo.SubscriptionResult<ConectionUpdatedSubscription>
...
export type RoundUpsBankConnectionsListQueryResult = Apollo.QueryResult<
  ...
  RoundUpsBankConnectionsListQueryVariables
>
export const RoundUpsConnectionsDocument = gql`
  query RoundUpsConnections($roundUpId: ID!, $id: ID!) {
    roundUp(id: $roundUpId) {
      id
      fundingAccount {
        ...AccountAttributes
...
/**
 * __useRoundUpsConnectionsQuery__
 *
 * To run a query within a React component, call `useRoundUpsConnectionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useRoundUpsConnectionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRoundUpsConnectionsQuery({
 *   variables: {
 *      roundUpId: // value for 'roundUpId'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useRoundUpsConnectionsQuery(
  baseOptions: Apollo.QueryHookOptions<RoundUpsConnectionsQuery, RoundUpsConnectionsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<RoundUpsConnectionsQuery, RoundUpsConnectionsQueryVariables>(
    RoundUpsConnectionsDocument,
    options
  )
}
export function useRoundUpsConnectionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    RoundUpsConnectionsQuery,
    RoundUpsConnectionsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<RoundUpsConnectionsQuery, RoundUpsConnectionsQueryVariables>(
    RoundUpsConnectionsDocument,
    options
  )
}
export type RoundUpsConnectionsQueryHookResult = ReturnType<typeof useRoundUpsConnectionsQuery>
export type RoundUpsConnectionsLazyQueryHookResult = ReturnType<
  typeof useRoundUpsConnectionsLazyQuery
>
export type RoundUpsConnectionsQueryResult = Apollo.QueryResult<
  RoundUpsConnectionsQuery,
  RoundUpsConnectionsQueryVariables
>
